...
public class TransactionAdapter implements TransactionGateway {
    ...
    @Override
    public BigDecimal getAmountAccountStatementByPeriod(final Integer accountId, final LocalDateTime startDate, final LocalDateTime endDate) {
        return transactionRepository.getAmountAccountStatementByPeriod(accountId, startDate, endDate);
    }
